...
2. `map_codebase` runs a stability check first (the project's actual build/test commands, from the Project-specific context block in `AGENTS.md`), then inventories files, types, tests, and working entry points:
