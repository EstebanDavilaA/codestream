...
5. Hand your findings to `roadmap_slices` so it can produce `.slipstream/ROADMAP.md` with Milestone 1 typically being either the stabilization slice (step 2) or "formalize what already works" (step 3) — not a rewrite.
