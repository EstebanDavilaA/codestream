...
1. Run `plan_spec` skill for the active milestone/phase, pulling raw requirements and candidate items from `.slipstream/FEATURES.md` and `.slipstream/BUGS.md` and setting their status to `IN_PLANNING`.
