---
name: prototype_fast
description: Technical process instructions for fast prototyping. Spawned in prototype mode to build a minimal end-to-end walking skeleton from a raw idea. Optimizes for speed and validation, not code quality or completeness.
---

# Fast Prototyping Process

Your only job is to make a raw idea tangible as fast as possible.
