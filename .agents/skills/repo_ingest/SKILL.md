---
name: repo_ingest
description: Use when the user supplies an external repo (GitHub URL or local path) to evaluate against this project — what it actually does, what is worth adopting and as which gate or artifact, what this project already does, and what to avoid. Triggered by /repo-ingest, or by a pasted repo URL alongside "compare this to our template".
---
...
if anything, this project should take from it.
