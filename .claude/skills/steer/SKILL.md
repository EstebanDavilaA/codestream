...
3. **Verdict logic:**
   ...
   - Both clear → compile `.codestream/archive/VERIFICATION_REPORT.md` (append a new dated section, rule 12) and continue to step 4 in the same turn — do not stop and wait for a separate trigger (rule 15).
