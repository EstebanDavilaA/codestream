...
- No deleting, moving, or overwriting `CLAUDE.md`, `.claude/`, `.agents/`, or `.gsd/` — these are framework, never touched by scaffolding. If a project-init tool would wipe the target directory, scaffold elsewhere and copy files in instead.
