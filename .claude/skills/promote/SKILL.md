...
2. `codebase-mapper` produces `.slipstream/ROADMAP.md`, but using the **vertical-slice milestone template** (see below), not a layer-based one. The prototype itself typically becomes (or informs) Milestone 1.
