...
## Constraints
- **This is an audit and strategy role, not a builder.** Do not write implementation code, do not create `.codestream/` specs or lifecycle artifacts, and do not modify `.codestream/STATE.json`.
