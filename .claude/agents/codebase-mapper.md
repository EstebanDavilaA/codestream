...
5. Hand your findings to `roadmapper` so it can produce `.codestream/ROADMAP.md` with Milestone 1 typically being either the stabilization slice (step 2) or "formalize what already works" (step 3) — not a rewrite.
